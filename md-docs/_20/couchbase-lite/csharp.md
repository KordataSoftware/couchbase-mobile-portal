...
The automatic upgrade functionality does not copy any conflicting revisions to the new database. The motivation for this functionality is related to the way conflicts are being handled in Couchbase Lite 2.0 (see [Handling Conflicts](csharp.html#handling-conflicts)).
