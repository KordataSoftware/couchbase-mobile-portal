...
The default Sync Function is documented in the API reference [`databases.$dbname.sync`](../../../guides/sync-gateway/config-properties/index.html#1.5/databases-foo_db-sync).
